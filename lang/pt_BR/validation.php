...
return [
    ...
    | como as regras de tamanho. Sinta-se à vontade para ajustar
    ...
    */
    ...
    | específica para uma dada regra de atributo.
    |
    */
    ...
    | em vez de "email". Isso simplesmente nos ajuda a tornar nossa
